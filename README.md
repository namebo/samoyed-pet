...
| 待机 | 走路 | 跳跃 | 开心 | 思考 | 歪头 | 打招呼 |
|------|------|------|------|------|------|--------|
| ![idle](demo/idle.gif) | ![walk](demo/walk.gif) | ![jump](demo/jump.gif) | ![happy](demo/happy.gif) | ![thinking](demo/thinking.gif) | ![headTilt](demo/headTilt.gif) | ![pawWave](demo/pawWave.gif) |
| **坐下** | **挠耳** | **睡觉** | **摇尾** | **吐舌** | **拖拽** | |
| ![sit](demo/sit.gif) | ![scratchEar](demo/scratchEar.gif) | ![sleeping](demo/sleeping.gif) | ![tailWag](demo/tailWag.gif) | ![tongueOut](demo/tongueOut.gif) | ![drag](demo/drag.gif) | |
